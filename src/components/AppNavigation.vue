<template>
  ...
  >
    <v-list nav width="200px">
      ...
      <div  v-if="access.tenders > 0"><v-list-item prepend-icon="mdi-view-dashboard"  title="Закупки" value="purchases" :to="'purchases'"></v-list-item></div>
      ...
      <div  v-if="access.users > 0"><v-list-item prepend-icon="mdi-account-group"  title="Пользователи" value="users" :to="'users'"></v-list-item></div>
    </v-list>
  </v-navigation-drawer>
</template>
<script>
